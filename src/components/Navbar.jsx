  ...
  return (
    <div className="navbar z-10 sticky top-0 bg-base-100 mb-10">
        <div className="flex-1">
            <h1 className="text-2xl ml-3"><NavLink to="/">Simple Tally</NavLink></h1>
        </div>
        <div className="flex-none">
          <label className="swap swap-rotate pt-1 mr-2">
             {/* this hidden checkbox controls the state */}
             <input type="checkbox" className="theme-controller" value="lofi" onClick={changeTheme} />
             {/* moon icon */}
